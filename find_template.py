...
# incom = pro.express(ts_code='002475.SZ', start_date='20230101', end_date='20240101', fields='ts_code,ann_date,end_date,revenue,operate_profit,total_profit,n_income,total_assets, yoy_tp')
# print(incom)
df = pro.express_vip(period='20240331',fields='ts_code,ann_date,end_date,revenue,operate_profit,total_profit,n_income,total_assets')
print(df)
# num = 0
# pe_avg = 0
...
#     incom = pro.express(ts_code=ts_code, start_date='20240425', end_date='20240425', fields='ts_code,ann_date,end_date,revenue,operate_profit,total_profit,n_income,total_assets, yoy_tp')
